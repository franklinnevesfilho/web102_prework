...
function addGamesToPage(games) {
    ...
    for(let i = 0; i < games.length; i++){
        ...
        const gameInfo = `
            <div>
                <img style="width: 15rem;"  src=${games[i].img} >
                <h3>${games[i].name}</h3>
...
const totalContributions = GAMES_JSON.reduce((count, game) => count + game.backers , 0)
...
const totalRaised = GAMES_JSON.reduce((count, game) => count + game.pledged , 0)
...
descContainer.append(document.createElement('p').innerHTML = displayStr);
...
let [bestGame, runnerUp, ...games] = sortedGames

let bestGameName = bestGame.name;
let runnerUpName = runnerUp.name;

// create a new element to hold the name of the top pledge game, then append it to the correct element
firstGameContainer.append(document.createElement('p').innerHTML = bestGameName)
// do the same for the runner up item
secondGameContainer.append(document.createElement('p').innerHTML = runnerUpName)
